  ...
  return (
    <div className="flex justify-center">
      <div className="flex flex-col items-center justify-center p-6 h-[80vh] w-full max-w-md">
        ...
        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2 p-4">{title}</h2>
        <p className="text-gray-600 dark:text-gray-300 text-center mb-8 whitespace-pre-line">{description}</p>
