  ...
  return (
    <div className="fixed inset-0 bg-black flex flex-col">
      <div className="flex-1 relative overflow-hidden">
        ...
        {/* 상단 안내 텍스트 */}
        <div className="absolute top-0 inset-x-0 p-6 bg-gradient-to-b from-black to-transparent">
      ...
      <div className="p-6 bg-gradient-to-t from-black to-transparent">
        <button
          ...
          className="w-full bg-white text-indigo-600 py-3 rounded-button font-semibold cursor-pointer"
        >
          취소
        </button>
      </div>
