    ...
    return (
      <div className="flex justify-center">
        <div className="flex flex-col items-center justify-center p-6 h-[80vh] w-full max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2 p-4">
            SUI 페이에 오신 것을 환영합니다
          </h2>
    ...
    <div className="flex justify-center">
      <div className="flex flex-col items-center p-6 w-full max-w-md">
        <div className="w-full bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-xl font-bold text-gray-700 dark:text-gray-200 mb-2 pb-2">
            SUI 잔액
          </h2>
          <div>
        ...
        <div className="mt-8 w-full py-2">
          <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-3 py-2">
            최근 거래 내역
          </h3>
