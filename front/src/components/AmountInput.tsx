    ...
    <div className="fixed inset-0 bg-white dark:bg-gray-900 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        ...
        <div className="text-center mb-8 p-4">
          <h1 className="text-xl font-medium text-gray-800 dark:text-white mb-2">
            {merchantName}에서
          </h1>
        ...
        <div className="text-center mb-4">
          <p className="text-5xl font-bold text-gray-900 dark:text-white mb-2 pb-2">
            {coinAmount} SUI
          </p>
          <p className="text-gray-500 dark:text-gray-400">
            지갑 잔고 {availableCoin} SUI
          </p>
          {parseFloat(amount) > balance && (
            <p className="text-red-500 dark:text-red-400 text-sm mt-2 pt-1">
              잔고가 부족합니다
            </p>
          )}
        </div>
